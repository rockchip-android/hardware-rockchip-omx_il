...
OMX_PTR Rockchip_OSAL_Strcpy(OMX_PTR dest, OMX_PTR src)
{
    return strcpy(dest, src);
}

OMX_PTR Rockchip_OSAL_Strncpy(OMX_PTR dest, OMX_PTR src, size_t num)
{
...
OMX_PTR Rockchip_OSAL_Strcat(OMX_PTR dest, OMX_PTR src)
{
    return strcat(dest, src);
}

OMX_PTR Rockchip_OSAL_Strncat(OMX_PTR dest, OMX_PTR src, size_t num)
{
